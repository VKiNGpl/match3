...
function StartState:init()
    ...
    self.colors = {
        [1] = {0.851, 0.34, 0.39, 1.0},
        [2] = {0.373, 0.804, 0.894, 1.0},
        [3] = {0.984, 0.95, 0.212, 1.0},
        [4] = {0.463, 0.259, 0.541, 1.0},
        [5] = {0.6, 0.9, 0.314, 1.0},
        [6] = {0.875, 0.443, 0.149, 1.0}
    }
...
function StartState:render()
    ...
    love.graphics.setColor(1.0, 1.0, 1.0, self.transitionAlpha)
    love.graphics.rectangle('fill', 0, 0, VIRTUAL_WIDTH, VIRTUAL_HEIGHT)
end
...
function StartState:drawOptions(y)
    ...
    if self.currentMenuItem == 1 then
        love.graphics.setColor(0.39, 0.608, 1.0, 1.0)
    else
        love.graphics.setColor(0.188, 0.376, 0.51, 1.0)
    end
...
function StartState:drawTextShadow(text, y)
    love.graphics.setColor(0.133, 0.125, 0.204, 1.0)
